...
----
curl -sSL https://gist.githubusercontent.com/tutsunom/2ea88c52340eda937f5cd7267714ee56/raw/fa8e35f4ea6e7ce7aef2bea7b86f2fc5d77230fa/rosa-ws-translation.sh | bash
----
